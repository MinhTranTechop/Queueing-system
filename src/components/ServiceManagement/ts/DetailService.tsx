...
const DetailService = () => {
  ...
  const handleSearch = (event: React.ChangeEvent<HTMLInputElement>): void => {
    ...
    const filteredEquipments: Progression[] = progression.filter(
      (eq: Progression) => {
                ...
                <div className="Action_status">
                  ...
                  >
                    ...
                    <ul className="list3">
                      <li
                        className="option"
                        onClick={() => handleOptionClickPr("Tất cả")}
                      >
                        <span className="option_text">Tất cả</span>
                      </li>
                      <li
                        className="option"
                        onClick={() => handleOptionClickPr("Đang thực hiện")}
                      >
                        <span className="option_text">Đang thực hiện</span>
                      </li>
                      <li
                        className="option"
                        onClick={() => handleOptionClickPr("Đã hoàn thành")}
                      >
                        <span className="option_text">Đã hoàn thành</span>
                      </li>
                      <li
                        className="option"
                        onClick={() => handleOptionClickPr("Vắng")}
                      >
                  ...
                  ? filteredProgression.map((eq, index) => (
                      ...
                      >
                        ...
                        <td>
                          {eq.Status_Pr === "wait" ? (
                            <div>
                              <img className="imgList" src={wait} alt="" />
