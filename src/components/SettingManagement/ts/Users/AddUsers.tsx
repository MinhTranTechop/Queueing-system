  ...
  return (
    <div className="AddEq-main">
      ...
      <div className="addEq-form">
        ...
        <div className="addEq-group">
          <div className="addEq-name">
            <p>Họ tên:</p>
            <input className="textaddEq" placeholder="Nhập họ tên " onChange={(e) => setName(e.target.value)}  />
          ...
          <div className="addEq-phone">
            <p>Số điện thoại:</p>
            <input className="textaddEq" placeholder="Nhập số điện thoại " onChange={(e)=>setPhone(e.target.value)}/>
          </div>
          ...
          <div className="addEq-email">
            <p>Email:</p>
            <input className="textaddEq" placeholder="Nhập email " onChange={(e)=> setEmail(e.target.value)} />
          </div>
      ...
      <div className="addEq_btn">
        ...
        <button className="addEq_Add" type="submit" onClick={handleAddUser}>Thêm</button>
      </div>
    </div>
  );
};
